...
class TutorialemerygencyScreen extends StatelessWidget {
  const TutorialemerygencyScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
        title: Text("Tutorials For Emergency"),
      ),
      body: Container(
        child: Column(
          children: [
            Expanded(
              child: ListView.builder(
                itemCount: tutorialsemergency.length,
                itemBuilder: (context, index) => GestureDetector(
                  onTap: () => launchURL(tutorialsemergency[index]['url']!),
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              tutorialsemergency[index]['title']!,
                              style: TextStyle(
                                  fontFamily: Typo.regular, fontSize: 12.sp),
                            ),
                            Text(
                              tutorialsemergency[index]['url']!,
                              style: TextStyle(
